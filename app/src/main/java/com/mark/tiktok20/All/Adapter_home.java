...
public class Adapter_home extends RecyclerView.Adapter<Adapter_home.ViewHolder>{
    ...
    public Adapter_home(Context context, List<ModelRv_home> modelRvList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.post_feed,viewGroup,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            Image = itemView.findViewById(R.id.feed_video);
            imageprofile = itemView.findViewById(R.id.profile_postclick);
            text_activity = itemView.findViewById(R.id.username_post);
